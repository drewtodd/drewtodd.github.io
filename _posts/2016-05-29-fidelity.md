...
However, the discussion this week with [Darren Hood](http://www.dwilliamhood.com/) revolved around the fact that wireframes don't have to be *ugly*. And it seems that there are [certain tools](https://balsamiq.com/) out there that, by default, lend themselves to some sloppy looking deliverables.
